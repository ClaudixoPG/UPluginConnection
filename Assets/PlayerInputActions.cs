...
public partial class @PlayerInputActions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""FishingGame"",
            ""id"": ""d44ae147-59ef-4ee4-9254-f9229b5716db"",
            ""actions"": [
                {
                    ""name"": ""PressScreen"",
                    ""type"": ""Button"",
                    ""id"": ""594ad938-048a-4661-83fc-f70e16244c26"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""f11fae04-8828-4dd8-8b3b-a5743d6d2c80"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""74610df0-4ed7-4ec6-a7fc-efeb05162b74"",
                    ""path"": ""<Gamepad>/buttonEast"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""0e7c4eb6-2797-4592-97d4-1ea4224f1adf"",
                    ""path"": ""<Keyboard>/upArrow"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    // FishingGame
    private readonly InputActionMap m_FishingGame;
    private List<IFishingGameActions> m_FishingGameActionsCallbackInterfaces = new List<IFishingGameActions>();
    private readonly InputAction m_FishingGame_PressScreen;
    /// <summary>
    /// Provides access to input actions defined in input action map "FishingGame".
    /// </summary>
    public struct FishingGameActions
    {
        private @PlayerInputActions m_Wrapper;
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public FishingGameActions(@PlayerInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "FishingGame/PressScreen".
        /// </summary>
        public InputAction @PressScreen => m_Wrapper.m_FishingGame_PressScreen;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_FishingGame; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="FishingGameActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(FishingGameActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="FishingGameActions" />
        public void AddCallbacks(IFishingGameActions instance)
        {
            if (instance == null || m_Wrapper.m_FishingGameActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_FishingGameActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="FishingGameActions" />
        private void UnregisterCallbacks(IFishingGameActions instance)
        {
            @PressScreen.started -= instance.OnPressScreen;
            @PressScreen.performed -= instance.OnPressScreen;
            @PressScreen.canceled -= instance.OnPressScreen;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="FishingGameActions.UnregisterCallbacks(IFishingGameActions)" />.
        /// </summary>
        /// <seealso cref="FishingGameActions.UnregisterCallbacks(IFishingGameActions)" />
        public void RemoveCallbacks(IFishingGameActions instance)
        {
            if (m_Wrapper.m_FishingGameActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="FishingGameActions.AddCallbacks(IFishingGameActions)" />
        /// <seealso cref="FishingGameActions.RemoveCallbacks(IFishingGameActions)" />
        /// <seealso cref="FishingGameActions.UnregisterCallbacks(IFishingGameActions)" />
        public void SetCallbacks(IFishingGameActions instance)
        {
            foreach (var item in m_Wrapper.m_FishingGameActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_FishingGameActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "FishingGame" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="FishingGameActions.AddCallbacks(IFishingGameActions)" />
    /// <seealso cref="FishingGameActions.RemoveCallbacks(IFishingGameActions)" />
    public interface IFishingGameActions
    {
        /// <summary>
